...
import (
	...
	"github.com/aslotsu/dev-meetups-gqlgen/models"
...
var sources = []*ast.Source{
	{Name: "meetups.graphqls", Input: sourceData("meetups.graphqls"), BuiltIn: false},
}
...
func (ec *executionContext) _Meetup_user(ctx context.Context, field graphql.CollectedField, obj *models.Meetup) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_meetups(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMeetup2ᚕᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐMeetupᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *models.Meetup) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋaslotsuᚋdevᚑmeetupsᚑgqlgenᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
